...
blocking_objects = ['person', 'stop sign']
class ObjectsOnRoadProcessor(object):
    def run(weights='yolov5s.pt',  # model.pt path(s)
        ...
        print('Creating a ObjectsOnRoadProcessor...')
        self.width = 640
        self.height = 480
        ...
        #
        self.traffic_objects = {7:GreenTrafficLight(),
                                0:Person(),
                                2:RedTrafficLight(),
                                3:SpeedLimit(25),
                                4:SpeedLimit(40),
    ...
    def control_car(self, objects):
        ...
        for object in objects:
            ...
            for index, value in enumerate(blocking_objects):
                if value == object:
                    processor = self.traffic_objects[index]
                    processor.set_car_state(car_state)
            #if object in blocking_objects:
             #   processor = self.traffic_objects[blocking_objects.index(object)]
             #   processor.set_car_state(car_state)[[[[[[[[[[[[
             #   print('Person detected. Speed now is: ', self.speed, '\n')
